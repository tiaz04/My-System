 ...
 */		
	public function index()
	{
		...
		$this->load->view('admin/news/index.php', $data);
 ...
 */	
	public function aggiungi()
	{
		...
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/aggiungi.php', $data);
		$this->load->view('template/adminfooter', $data);
 ...
 */		
	public function aggiungidb()
	{
	    ...
	    $data['risultato_inserimento']=$this->Newsclass->inserisci_news($data_img);
	    
	    
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/confermainserimento.php', $data);
		$this->load->view('template/adminfooter', $data);
 ...
 */		
		public function modifica($id)
	{
	    ...
	    $data['news'] = $this->Newsclass->dati_news($id);  
	    
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/modifica.php', $data);
		$this->load->view('template/adminfooter', $data);
 ...
 */		
	public function modificadb($id)
	{
	    ...
	    $data['risultato_inserimento']=$this->Newsclass->modifica_news($id,$data_img);
   
	    
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/confermamodifica.php', $data);
		$this->load->view('template/adminfooter', $data);
 ...
 */	
	public function elimina($id)
	{
	    ...
	    $data['risultato_inserimento']=$this->Newsclass->cancella_news($id);
   
	    
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/confermacancellazione.php', $data);
		$this->load->view('template/adminfooter', $data);
        ...
        public function aggiungicat()
	{
		...
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/aggiungicat.php', $data);
		$this->load->view('template/adminfooter', $data);
        ...
        public function aggiungicatdb()
	{
	    ...
	    $data['risultato_inserimento']=$this->Newsclass->inserisci_catnews();
	...
	public function listacat()
	{
	    ...
	    $data['lista_cat'] = $this->Newsclass->lista_catnews();  
	    
	    
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/listacat.php', $data);
		$this->load->view('template/adminfooter', $data);
	...
	public function modificacat($id)
	{
	    ...
	    $data['catpagine'] = $this->Newsclass->dati_catnews($id);  
	    
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/modificacat.php', $data);
		$this->load->view('template/adminfooter', $data);
 ...
 */		
	public function modificacatdb($id)
	{
	    ...
	    $data['risultato_inserimento']=$this->Newsclass->modifica_catnews($id);
            
           
	    
		$this->load->view('template/adminheader', $data);
		$this->load->view('admin/news/confermamodificacat.php', $data);
		$this->load->view('template/adminfooter', $data);
 ...
 */	
	public function eliminacat($id)
	{
	    ...
	    $data['risultato_inserimento']=$this->Newsclass->cancella_newscat($id);
