...
<h2>Inserimento Press</h2>
<?

$attributes = array('id' => 'tobevalidate');

echo form_open_multipart('admin/press/aggiungidb',$attributes);
...
<div class="row">
<div class="col-sm-9">
     <? echo form_input_nci('Titolo Press', 'titolo', '', 'class="required form-control"'); ?>
        <? echo form_input_nci('Sottotitolo', 'sottotitolo'); ?>
        <? echo form_textarea_nci('Testo Press', 'testo', '', 'class="ckeditor required"'); ?>
...
<p><label for="mysubmit">Operazioni</label>
    ...
    <? echo form_submit('mysubmit', 'Pubblica Press', 'class="btn btn-primary btn-block btn-lg buttonclass"'); ?>
</p>
</div>
<div class="modulo">
...
<div class="modulo">
<p><label for="myfile">File Press</label><input type="file" name="userfile">
</p>
</div>
